...
insert into public.permissions (slug, can_manage_users, can_manage_financials, can_manage_projects, can_manage_tasks, can_view_sensitive_data, can_approve_requests)
values 
  ('admin', true, true, true, true, true, true),
  ('chair', true, true, true, true, true, true),
  ('manager', false, false, true, true, false, true),
  ('member', false, false, false, true, false, false),
  ('external', false, false, false, false, false, false);
