    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 bg-white p-2 rounded-xl border border-gray-200 shadow-sm">
           <span className="text-xs font-bold text-gray-500 uppercase px-2">Editando:</span>
           <select 
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
           ...
           <div className="relative flex items-center gap-5">
              <img 
                ...
                className="w-20 h-20 rounded-xl border-4 border-white/10 bg-slate-700 object-cover" 
                alt="Avatar"
              />
              <div>
                 <h2 className="text-2xl font-bold">{selectedUser.nome}</h2>
                 <div className="flex items-center gap-3 mt-2 text-slate-300 text-sm">
                    {userChapter && (
                       <span className="flex items-center gap-1.5 bg-white/10 px-2 py-0.5 rounded-md backdrop-blur-md">
                          <Briefcase className="w-3.5 h-3.5" />
                          {userChapter.sigla}
                       </span>
                    )}
                    <span className="flex items-center gap-1.5 bg-blue-500/20 text-blue-200 px-2 py-0.5 rounded-md border border-blue-500/30">
                       <BadgeCheck className="w-3.5 h-3.5" />
                       {selectedUser.role}
                    </span>
                    <span className="flex items-center gap-1 opacity-60" title="Campo não editável">
                 ...
                 <div className="space-y-4">
                    <div className="space-y-1.5">
                       ...
                       <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm transition-all focus-within:ring-2 focus-within:ring-purple-100 focus-within:border-purple-300">
                           ...
                           {showBioPreview ? (
                              <div className="w-full px-4 py-3 min-h-[160px] prose prose-sm max-w-none text-gray-600 bg-gray-50/50 overflow-y-auto">
                    ...
                    <div className="space-y-1.5">
                       ...
                       <div className="flex gap-2">
                          <input 
                             type="text" 
                             className="flex-1 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-purple-100 outline-none transition-all text-sm"
                       ...
                       <div className="flex flex-wrap gap-2 mt-3 min-h-[40px]">
                          {formData.habilidades.map(skill => (
                             <span key={skill} className="px-3 py-1 bg-purple-50 text-purple-700 border border-purple-100 rounded-lg text-sm font-medium flex items-center gap-1.5">
                                {skill}
                    ...
                    <div className="space-y-1.5 relative" ref={pickerRef}>
                       <label className="text-sm font-semibold text-gray-700 flex items-center justify-between gap-1.5">
                          <div className="flex items-center gap-1.5">
                            <Palette className="w-3.5 h-3.5" /> Capa (URL ou Gradiente)
                          </div>
                       </label>
                       ...
                       <div className="flex gap-2">
                          <input 
                              type="text" 
                              className="flex-1 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-orange-100 outline-none transition-all text-sm truncate"
                              placeholder="https://... ou from-blue-500..."
                          ...
                          <button
                            ...
                            className={`p-2.5 rounded-xl border transition-all ${showGradientPicker ? 'bg-orange-100 border-orange-200 text-orange-600' : 'bg-gray-50 border-gray-200 text-gray-500 hover:bg-gray-100'}`}
                       ...
                       {showGradientPicker && (
                         <div className="absolute right-0 top-full mt-2 w-72 md:w-80 bg-white rounded-2xl shadow-xl border border-gray-200 z-50 p-4 animate-in fade-in slide-in-from-top-2">
                           <div className="flex items-center justify-between mb-3 border-b border-gray-100 pb-2">
                             <span className="text-sm font-bold text-gray-800">Gerador de Gradiente</span>
                       ...
                       <div className="mt-2 h-16 w-full rounded-lg overflow-hidden border border-gray-200 relative">
                          {formData.coverConfig.startsWith('http') ? (
                             <img src={formData.coverConfig} className="w-full h-full object-cover" alt="Preview" />
                          ) : (
                             <div className={`w-full h-full bg-gradient-to-r ${formData.coverConfig}`}></div>
                          )}
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                 ...
                 <div className="space-y-3">
                    <div className="flex items-center gap-3">
                       ...
                       <input 
                          type="text" 
                          className="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm"
                    ...
                    <div className="flex items-center gap-3">
                       ...
                       <input 
                          type="text" 
                          className="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-gray-200 outline-none transition-all text-sm"
                    ...
                    <div className="flex items-center gap-3">
                       ...
                       <input 
                          type="text" 
                          className="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-pink-100 outline-none transition-all text-sm"
