...
export const ProjectDetails = () => {
  ...
  const projeto = projects.find((p: any) => p.id === Number(id));
      ...
      <div className="hidden md:grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
        <div 
          ...
          className={`bg-white p-4 rounded-xl shadow-sm border-2 cursor-pointer transition-all ${
            filterStatus === 'all' ? 'border-blue-600' : 'border-gray-100 hover:border-gray-200'
          }`}
        >
        ...
        <div 
          ...
          className={`bg-white p-4 rounded-xl shadow-sm border-2 cursor-pointer transition-all ${
            filterStatus === 'todo' ? 'border-gray-600' : 'border-gray-100 hover:border-gray-200'
          }`}
        >
        ...
        <div 
          ...
          className={`bg-white p-4 rounded-xl shadow-sm border-2 cursor-pointer transition-all ${
            filterStatus === 'doing' ? 'border-blue-600' : 'border-gray-100 hover:border-gray-200'
          }`}
        >
        ...
        <div 
          ...
          className={`bg-white p-4 rounded-xl shadow-sm border-2 cursor-pointer transition-all ${
            filterStatus === 'review' ? 'border-yellow-600' : 'border-gray-100 hover:border-gray-200'
          }`}
        >
        ...
        <div 
          ...
          className={`bg-white p-4 rounded-xl shadow-sm border-2 cursor-pointer transition-all ${
            filterStatus === 'done' ? 'border-green-600' : 'border-gray-100 hover:border-gray-200'
          }`}
        >
