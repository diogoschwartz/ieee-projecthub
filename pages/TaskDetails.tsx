...
export const TaskDetails = () => {
  ...
  const task = tasks.find((t: any) => t.id === Number(id));
                 ...
                 <div className="bg-gray-50 p-1 rounded-lg flex inline-flex self-start overflow-x-auto">
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all flex items-center gap-1.5 whitespace-nowrap ${
                        newResDisplay === 'iframe-100' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all flex items-center gap-1.5 whitespace-nowrap ${
                        newResDisplay === 'iframe-50' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all flex items-center gap-1.5 whitespace-nowrap ${
                        newResDisplay === 'link-only' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
