    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-lg border border-gray-100 group">
        ...
        <div className="absolute -bottom-12 left-6 md:left-10 flex items-end">
          <div className={`w-24 h-24 md:w-32 md:h-32 rounded-2xl bg-gradient-to-br ${chapter.cor} p-1 shadow-2xl ring-4 ring-white`}>
      ...
      <div className="mt-14 px-2 md:px-4">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900">{chapter.nome}</h1>
            <p className="text-lg text-gray-500 font-medium mb-4">{chapter.sigla}</p>
